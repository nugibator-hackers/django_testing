...
class TestNoteCreation(TestCase):
    ...
    def setUpTestData(cls):
        cls.author = User.objects.create(username='Канэки Кэн')
    ...
    def test_slug_must_be_unique(self):
        ...
        responce = self.client.post(self.ADD_NOTE_URL, data=self.form_data)
    ...
    def test_generated_automatically_slug(self):
        ...
        responce = self.client.post(self.ADD_NOTE_URL,
                                    data=self.form_data)
...
class TestNoteEditDelete(TestCase):
    ...
    def test_author_can_delete_note(self):
        responce = self.author_client.post(self.delete_note_url)
        self.assertRedirects(responce, reverse('notes:success'))
    ...
    def test_other_user_cant_delete_note(self):
        responce = self.reader_client.post(self.delete_note_url)
        self.assertEqual(responce.status_code, HTTPStatus.NOT_FOUND)
